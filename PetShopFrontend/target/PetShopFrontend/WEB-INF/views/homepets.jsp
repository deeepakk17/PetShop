					...
					<div class="col-item">
						...
						<div class="info">
							...
							<c:if test="${product.quantity >0 }">
								<p class="btn-add">
									<i class="fa fa-shopping-cart"></i><a href="<c:url value="user/addusercart/${product.id}"/>"
								...
								<p class="btn-add">
									<i class="fa fa-list"></i><a href="<c:url value="/product/edit/${product.id}"/>"
										class="hidden-sm">Edit</a>
								</p>
								<p class="btn-details">
									<i class="fa fa-list"></i><a href="<c:url value="/product/deleteitem/${product.id}"/>" class="hidden-sm">Delete</a>
								</p>
								</sec:authorize>
							</div>
